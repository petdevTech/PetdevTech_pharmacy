...
<h1 class="text-center"> Add New Item</h1>
    <div class="container">
        <form class="form-horizontal addForm" action="?action=insert" method= "POST" enctype = "multipart/form-data">
            <div class="row">
                <div class="col-md-4">
                    <div class="myimg">
                        <img 
                ...
                <div class="col-md-8">
                    ...
                    <div class="row inputField">
                        <i class="fa-regular fa-user col-md-2 col-sm-2"></i>
                        <div class="col-sm-10 col-md-6 form-floating">
                            <input id="floatinguser" type="text" name="name" class="form-control" required="required" placeholder="Username">
                    ...
                    <div class="row inputField">
                        <i class="fa-duotone fa-lock col-md-2 col-sm-2"></i>
                        <div class="col-sm-10 col-md-6 form-floating">
                            <input id="floatingpass" type="text" name="description" class="form-control" autocomplete="off" required="required" placeholder="Password">
                    ...
                    <!-- Start Price Field -->
                    <div class="row inputField">
                        <i class="fa-duotone fa-tags col-md-2 col-sm-2"></i>
                        <div class="col-sm-10 col-md-6 form-floating">
                            <input id="floatingprice" type="text" name="price" class="form-control" autocomplete="off" required="required" placeholder="price">
                    ...
                    <!-- Start Made in Field -->
                        <div class="col-sm-10 col-md-6 form-floating">
                            <input id="floatingcountry" type="text" name="country" class="form-control" autocomplete="off" required="required" placeholder="Country Made">
                            <label for="floatingcountry">Country Made</label>
                        </div>
                    <!-- End Made in Field -->
                    <!-- Start Status Field -->
