    ...
    if (isset($_POST['login'])){
        ...
        if (empty ($formerrors)){
            ...
            if ($check == 1){
                ...
                $successMsg = ' Congrats you Are Now a Member In Our Humble Family ';
...
<div id ="log" class="container-fluid login-page">
    ...
    <form id = "signup"  class="signup" action="<?php echo $_SERVER['PHP_SELF'];?>" method="POST">
        <h1 class="text-center">
            <span data-class="signup">Signup</span>
        </h1>
        <div class="input-container">
